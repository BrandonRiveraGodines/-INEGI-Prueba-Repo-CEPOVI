package com.company.cubaforcepovidevelop;
...
public class CubaforcepovidevelopTestContainer extends TestContainer {

    public CubaforcepovidevelopTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/cubaforcepovidevelop/app.properties",
    ...
    public static class Common extends CubaforcepovidevelopTestContainer {

        public static final CubaforcepovidevelopTestContainer.Common INSTANCE = new CubaforcepovidevelopTestContainer.Common();
